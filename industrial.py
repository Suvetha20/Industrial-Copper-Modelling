...
<div style='text-align:center'>
    <h1 style='color:#990099;'>Industrial Copper Modeling</h1>
</div>
        ...
        with st.form("my_form1"):
            ...
            # 'quantity tons_log', 'selling_price_log','application', 'thickness_log', 'width','country','customer','product_ref']].values, X_ohe
                ...
                if new_pred==1:
                    ...
                    st.write('## :red[The status is Lost 🤷‍♀️] ')

st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Suve', unsafe_allow_html=True )  
